...
class EventTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        if getBalance(cls.caller1) == 0:
            ...
            print("Done\n")
        cls.token.transfer(ETH_TOKEN_MINT_ID, 2000, get_associated_token_address(PublicKey(cls.caller1), ETH_TOKEN_MINT_ID))
        ...
        cls.token.transfer(ETH_TOKEN_MINT_ID, 2000, get_associated_token_address(PublicKey(cls.caller2), ETH_TOKEN_MINT_ID))
