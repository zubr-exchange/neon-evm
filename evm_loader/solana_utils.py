...
#    return TransactionInstruction(
#        program_id=evm_loader_program_id,
#        data=(13).to_bytes(1,'big') + collateral_pool_index_buf + step_count.to_bytes(8, byteorder='little') + evm_instruction,
#        keys=[
...
#def create_neon_evm_instr_10_continue(evm_loader_program_id,
#                                      caller_sol_acc,
#                                      operator_sol_acc,
#                                      storage_sol_acc,
#                                      contract_sol_acc,
#                                      code_sol_acc,
#                                      collateral_pool_index_buf,  # added
#                                      collateral_pool_address,    # added
#                                      step_count,
#                                      writable_code=True):
#    return TransactionInstruction(
#        program_id=evm_loader_program_id,
#        data=(10).to_bytes(1,'big') + step_count.to_bytes(8, byteorder='little'),
#        keys=[
...
#    return TransactionInstruction(
#        program_id=evm_loader_program_id,
#        data=(14).to_bytes(1,'big') + collateral_pool_index_buf + step_count.to_bytes(8, byteorder='little'),
#        keys=[
...
def create_neon_evm_instr_call_combined(evm_loader_program_id,
                                               caller_sol_acc,
                                               operator_sol_acc,
                                               storage_sol_acc,
                                               contract_sol_acc,
...
def create_neon_evm_instr_call_from_holder_combined(evm_loader_program_id,
                                               caller_sol_acc,
                                               operator_sol_acc,
                                               storage_sol_acc,
                                               holder_sol_acc,
